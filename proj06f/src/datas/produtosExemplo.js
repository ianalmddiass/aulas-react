const ProdutosExemplo = [
    {
        codigo: "1",
        marca: "Pro-x",
        modelo: "Bmx BULL Aro 20",
        preco: 2690.00,
        descricao: "A bike BMX Bull é uma ótima opção para atletas amadores que buscam um equipamento confiável e resistente para a prática do BMX. Seu quadro é construído em aço hi-ten, o que garante uma boa durabilidade e resistência aos impactos típicos dessa modalidade esportiva.",
        imagens: [
